import { Table, TableBody, TableCell, TableHead, TableRow, TableCaption, TableHeader } from "../ui/table"
...
// setting the limits. Sort posts in descending order based on date.
                ...
                {filteredPosts.map((post) => (
                    <TableRow key={post.id}>
                        ...
                        <TableCell>
                            ...
                            py-2 px-4 rounded text-xs">edit</button></Link>
                        </TableCell>
                    </TableRow>
                ))}
            </TableBody>
